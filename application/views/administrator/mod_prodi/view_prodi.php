            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-primary btn-sm' href='<?php echo base_url(); ?>administrator/tambah_prodi'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                ...
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_prodi/$row[id_prodi]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }
