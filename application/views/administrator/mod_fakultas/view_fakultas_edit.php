<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_fakultas',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$rows[id_fakultas]'>
                    <tr><th width='120px' scope='row'>Nama Fakultas</th>   <td><input type='text' class='form-control' name='a' value='$rows[nm_fakultas]'></td></tr>
                    ...
                    <tr><th scope='row'>Ganti Cover</th>          <td><input type='file' class='form-control' name='c'><hr style='margin:5px'>";
                                                                   if ($rows['gbr_fakultas']!=''){ echo " Gambar Saat ini : <a target='_BLANK' href='".base_url()."asset/img_album/$rows[gbr_fakultas]'>$rows[gbr_fakultas]</a>"; } echo "</td></tr>
